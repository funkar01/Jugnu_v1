...
const assets: AssetManifest = {
  ...
  // ── Monaco GP F1 360 panoramas — 9 circuit views ───────────────────────────
  monacogp_1: { url: "./360Videos/monacogp (1).png", type: AssetType.Texture, priority: "critical" },
  monacogp_2: { url: "./360Videos/monacogp (2).png", type: AssetType.Texture, priority: "critical" },
  monacogp_3: { url: "./360Videos/monacogp (3).png", type: AssetType.Texture, priority: "critical" },
  monacogp_4: { url: "./360Videos/monacogp (4).png", type: AssetType.Texture, priority: "critical" },
  monacogp_5: { url: "./360Videos/monacogp (5).png", type: AssetType.Texture, priority: "critical" },
  monacogp_6: { url: "./360Videos/monacogp (6).png", type: AssetType.Texture, priority: "critical" },
