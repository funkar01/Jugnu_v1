...
export default function WebAdvantages() {
  ...
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto border-t border-red-500/20 bg-slate-950/10">
      
      {/* Headings */}
      <div className="text-center mb-16">
        <span className="px-3 py-1 text-[10px] font-mono tracking-widest bg-slate-950/80 border border-red-500/30 text-orange-400 rounded-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div 
          onClick={triggerBeep}
          className="md:col-span-8 p-8 bg-slate-900/60 border border-red-500/20 hover:border-red-400/50 rounded-3xl transition-all duration-300 relative group cursor-pointer overflow-hidden backdrop-blur-md shadow-xl"
        >
          <div className="absolute top-0 right-0 w-44 h-44 bg-red-500/5 rounded-full filter blur-[50px] transition-all group-hover:bg-red-500/10" />
          
          <div className="flex flex-col h-full justify-between gap-6">
            <div className="space-y-3">
              <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-2xl w-fit">
                <RefreshCw className="w-6 h-6 text-red-400 animate-spin" style={{ animationDuration: '8s' }} />
              </div>
            ...
            <div className="pt-4 border-t border-red-500/10 flex flex-wrap items-center gap-6 text-xs font-mono text-slate-500">
        ...
        <div 
          onClick={triggerBeep}
          className="md:col-span-4 p-8 bg-slate-900/60 border border-red-500/20 hover:border-orange-400/50 rounded-3xl transition-all duration-300 relative group cursor-pointer backdrop-blur-md shadow-xl"
        >
        ...
        <div 
          onClick={triggerBeep}
          className="md:col-span-4 p-8 bg-slate-900/60 border border-red-500/20 hover:border-purple-400/50 rounded-3xl transition-all duration-300 relative group cursor-pointer backdrop-blur-md shadow-xl"
        >
          ...
          <div className="flex flex-col h-full justify-between gap-6">
            ...
            <div className="pt-4 border-t border-red-500/10 flex items-center gap-2 text-[10px] font-mono text-slate-500">
        ...
        <div 
          onClick={triggerBeep}
          className="md:col-span-8 p-8 bg-slate-900/60 border border-red-500/20 hover:border-emerald-400/50 rounded-3xl transition-all duration-300 relative group cursor-pointer overflow-hidden backdrop-blur-md shadow-xl"
        >
          ...
          <div className="flex flex-col h-full justify-between gap-6">
            ...
            <div className="pt-4 border-t border-red-500/10 flex items-center justify-between text-xs font-mono text-slate-500">
